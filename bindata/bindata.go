...
func resourcesDocHtml() (*asset, error) {
	bytes, err := resourcesDocHtmlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "resources/template.html", size: 8161, mode: os.FileMode(420), modTime: time.Unix(1461135721, 0)}
...
var _bindata = map[string]func() (*asset, error){
	"resources/template.html": resourcesDocHtml,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"resources": &bintree{nil, map[string]*bintree{
		"template.html": &bintree{resourcesDocHtml, map[string]*bintree{}},
	}},
}}
